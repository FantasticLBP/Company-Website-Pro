                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" id="newBelief" href="newStaff.php">发布员工培养</a></div>                            <div class="col-xs-5"></div>
...
<script type="text/javascript">
    ...
    function deleteProduct($staffId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/Staff.php?type=delete&staffId=" + $staffId,
    ...
    jQuery(function ($) {
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "../controller/Staff.php?type=select",
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td3 = $('<td class="hidden-480 center">' + datas[i].tag + '</td>').appendTo(tr);
