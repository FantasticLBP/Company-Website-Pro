                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" href="newServiesModule.php">发布新模块</a></div>                            <div class="col-xs-5"></div>
...
<script type="text/javascript">
    ...
    var message = location.hash.substr(3);
    ...
    //删除里程碑
    function deleteProduct($moudleId) {
        swal({
            title: "操作提示",
            text: "确认要删除该技术服务模块吗？",
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/TechKinds.php?type=delete&moduleId=" + $moudleId,
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td3 = $('<td class="hidden-480 center">' + datas[i].moduleName + '</td>').appendTo(tr);
                        var td4 = $('<td class=" center">' + datas[i].time + '</td>').appendTo(tr);
                        var td5 = $('<td class=" hidden-480 center">' + datas[i].author + '</td>').appendTo(tr);
                        var td7 = $('<td class="center"><div class="visible-md visible-lg visible-sm  action-buttons"><a  class="btn btn-xs btn-info"  role="button" href="servies.php?id=' + datas[i].id + '" id="edit' + datas[i].id + '"><i class="icon-remove bigger-120">服务管理</i></a>  <a  class="btn btn-xs btn-warning"  role="button" id="delete' + datas[i].id + '"  onclick="deleteProduct(' + datas[i].id + ');"><i class="icon-remove bigger-120"  >删除</i></a></div></td>').appendTo(tr);
                    }
