...
<head>
    <meta charset="utf-8"/>
    <title>杭州北望信息管理系统 - 发布激励保障</title>
    <meta name="keywords" content=" 杭州北望信息管理系统,后台管理系统,生物医药,杭州,合同服务"/>
    <meta name="description" content="杭州北望信息管理系统之招贤纳士之发布激励保障"/>
...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Encouragement.php"
                              method="post" enctype="multipart/form-data" onsubmit="return encouragementValidate()">

                            <div class="form-group">
                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" name="encouragementId" id="encouragementId" class="col-xs-10 col-sm-10 hidden"/>

                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="id-input-file-1">附图</label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="contentCopy">激励保障内容</label>
                                </div>
                                <div class="col-sm-11 col-md-11 col-lg-11">
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "../controller/Encouragement.php?type=select",
            success: function (data) {
                if (data.code == 200) {
                    data = data.data[0];
                    $("#encouragementId").val(data.id);
                    $("#contentCopy").html(data.content);
                }
            },
