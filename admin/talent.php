                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" id="newBelief" href="newTalent.php">发布人才招聘</a></div>                            <div class="col-xs-5"></div>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480 center">招聘人数</th>
                                            <th class="hidden-480 center">发布时间</th>
...
<script type="text/javascript">
    ...
    //删除里程碑
    function deleteProduct($employeefId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/Employee.php?type=delete&employeefId=" + $employeefId,
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td3 = $('<td class="hidden-480 center">' + datas[i].job + '</td>').appendTo(tr);
                        var td4 = $('<td class=" center">' + datas[i].place + '</td>').appendTo(tr);
                        var td5 = $('<td class=" hidden-480 center">' + datas[i].vacancy + '</td>').appendTo(tr);
                        var td6 = $('<td class=" hidden-480 center">' + datas[i].time + '</td>').appendTo(tr);
