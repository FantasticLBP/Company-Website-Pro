...
<head>
    <meta charset="utf-8" />
    <title>杭州北望生物技术有限公司信息管理系统|其它管理</title>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="center">送货方式</th>
                                            <th class=" center">加收金额</th>
                                            <th class="  center">排 序</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr><td class="center">
                                                ...
                                                <td class="center"><input type="text" id="categoryName" value="城市快递" /></td>
                                                <td class="hidden-480 center"><input type="text" id="categoryRank" value="20" />元</td>
                                                <td class="hidden-480 center"><input type="text" id="categoryRank" value="1" /></td>
                                                ...
                                                <td class="center">
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <a  class="btn btn-xs btn-info"  role="button" href="userDetail.php" ><i class="icon-edit bigger-120">编辑</i></a>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="center">送货方式</th>
                                            <th class="hidden-480 center">加收金额</th>
                                        ...
                                        <tr><td class="center">
                                            ...
                                            <td class="center"><input type="text" id="categoryName" value="" /></td>
                                            <td class="hidden-480 center"><input type="text" id="categoryRank" value="" /></td>
                                            <td class="hidden-480 center"><input type="text" id="categoryRank" value="" /></td>

                                            <td class="center">
                                                <div class="visible-md visible-lg visible-sm visible-xs action-buttons">

                                                    <a  class="btn btn-xs btn-info"  role="button" href="userDetail.php" ><i class="icon-plus bigger-120">添加</i></a>
