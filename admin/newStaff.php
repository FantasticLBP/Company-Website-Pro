...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Staff.php"
                              method="post" enctype="multipart/form-data" onsubmit="return staffValidate()">

                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="staffTag">标签</label>

                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" id="staffTag" name="staffTag" placeholder="请输入员工培养标签"
                                           class="col-xs-10 col-sm-10"/>
                                </div>
                            </div>
                            <div class="form-group hidden" id="staffTagError">
    ...
    <script type="text/javascript">
        ...
        $("#staffTag").on("blur", function () {
            if ($("#staffTag").val() === "") {
                $("#staffTagError").removeClass("hidden");
                $("#staffTagError>div").text("温馨提示：员工培养标签不能为空");
            } else {
                $("#staffTagError").addClass("hidden");
            }
        });
