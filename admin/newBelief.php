...
<head>
    <meta charset="utf-8"/>
    <title>杭州北望信息管理系统 - 发布人才理念</title>
    <meta name="keywords" content=" 杭州北望信息管理系统,后台管理系统,生物医药,杭州,合同服务"/>
    <meta name="description" content="杭州北望信息管理系统之招贤纳士之人才理念"/>
...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Belief.php"
                              method="post" enctype="multipart/form-data" onsubmit="return beliefValidate()">

                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="title">标题</label>

                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" id="title" name="title" placeholder="请输入人才理念标题"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" id="content" name="content" placeholder="请输入人才理念内容"
                                           class="col-xs-10 col-sm-10"/>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        if(message != "" && message != null && message != undefined){
            swal(message);
            setTimeout(function () {
                window.location.href = "belief.php";
            }, 1000);
        }
        ...
        $("#title").on("blur", function () {
            if ($("#title").val() === "") {
                ...
                $("#titleError>div").text("温馨提示：人才理念标题不能为空");
            } else {
        ...
        $("#content").on("blur",function(){
            if ($("#content").val() === "") {
                ...
                $("#contentError>div").text("温馨提示：人才理念内容不能为空");
            } else {
                $("#contentError").addClass("hidden");
            }
        });

        function beliefValidate() {
            var whether = false;
