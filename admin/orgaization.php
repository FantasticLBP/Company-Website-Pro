...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Organization.php"
                            ...
                            <div class="form-group">
                                <div class="row-fluid ">
                                    <label class="col-sm-3 control-label no-padding-right align-center"
                                           for="availableScope" style="text-align: left">公司组织结构图片预览</label>

                                    <div class="col-sm-9">
                                        <ul class="ace-thumbnails">
                                            <li id="structureImage">
		...
		try {
			...
			$.fn.colorbox.load();//to redraw the current frame
                    ...
                    $.ajax({
                        dataType: "json",
                        type: "get",
                        url: "../controller/Organization.php?type=detail",
                        success: function (data) {
                            if (data.code == 200) {
                                var datas = data.data[0];
                                if (jQuery.isEmptyObject(datas) || datas.length == 0) {
                                    $("#structureImage>a>img").prop("alt", "未上传图片");
                                    return;
                                }
                                $("#editId").val(datas.id);
                                if (datas.structureImage != "") {
                                    $("#structureImage>a").prop("href", "../" + datas.structureImage);
                                    $("#structureImage>a>img").prop("src", "../" + datas.structureImage);
                                } else {
                                    $("#structureImage>a>img").prop("alt", "未上传图片");
                                }
                            }
