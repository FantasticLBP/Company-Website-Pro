                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480 center">联系邮箱</th>
                                            <th class="hidden-480 center">工作经验</th>
...
<script type="text/javascript">
    ...
    //删除里程碑
    function deleteProduct($resumeId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/Resume.php?type=delete&resumeId=" + $resumeId,
    ...
    jQuery(function ($) {
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "../controller/Resume.php?type=select",
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td2 = $('<td class="center">' + datas[i].username + '</td>').appendTo(tr);
                        var td3 = $('<td class="hidden-480 center">' + datas[i].gender+ '</td>').appendTo(tr);
                        var td4 = $('<td class="center">' + datas[i].job + '</td>').appendTo(tr);
                        var td5 = $('<td class="hidden-480 center">' + datas[i].phone + '</td>').appendTo(tr);
                        var td6 = $('<td class="hidden-480 center">' + datas[i].email + '</td>').appendTo(tr);
                        var td6 = $('<td class="hidden-480 center">' +  (datas[i].experience.toString().toString().length>10? datas[i].experience.toString().substr(0,10):datas[i].experience) + '</td>').appendTo(tr);
