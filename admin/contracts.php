                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" href="newContract.php">发布CRO合同服务</a></div>                            <div class="col-xs-5"></div>
...
<script type="text/javascript">
    ...
    //删除里程碑
    function deleteProduct($contractId) {

        swal({
            title: "操作提示",
            text: "确认要删除该条CRO合同服务吗？",
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/ContractService.php?type=delete&contractId=" + $contractId,
    ...
    jQuery(function ($) {
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "../controller/ContractService.php?type=selectAll",
            success: function (data) {
                if (data.code == 200) {
