...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Employee.php"
                              method="post" enctype="multipart/form-data"  onsubmit="return employeeValidate()">

                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="job">招聘职位</label>
                                </div>

                                <div class="col-sm-11">
                                    <input type="text" id="job" name="job" placeholder="请输入招聘职位"
                                           class="col-xs-11 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group hidden" id="jobError">
                            ...
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="place">工作地点</label>
                                </div>

                                <div class="col-sm-11">
                                    <input type="text" id="place" name="place" placeholder="请输入工作地点"
                                           class="col-xs-11 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group hidden" id="placeError">
                                <label class="col-sm-1 control-label no-padding-right"></label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="vacancy">招聘人数</label>
                                </div>

                                <div class="col-sm-11">
                                    <input type="text" id="vacancy" name="vacancy" placeholder="请输入招聘人数"
                                           class="col-xs-11 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group hidden" id="vacancyError">
                                <label class="col-sm-1 control-label no-padding-right"></label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="baseconditionCopy">任职要求</label>
                                </div>
                                <div class="col-sm-11">
                            ...
                            <div class="clearfix ">
                                <div class="col-md-offset-3 col-md-9">
                                    <input type="submit" value="提交" id="upload" class="btn btn-info"/>
                                </div>
                            </div>
                    </div>
    ...
    <script type="text/javascript">
		...
		try {
            ...
            $("#job").on("blur", function () {
                if ($("#job").val() === "") {
                    $("#jobError").removeClass("hidden");
                    $("#jobError>div").text("温馨提示：职位不能为空");
                } else {
                    $("#jobError").addClass("hidden");
                }
            });

            $("#place").on("blur", function () {
                if ($("#place").val() === "") {
                    $("#placeError").removeClass("hidden");
                    $("#placeError>div").text("温馨提示：工作地点不能为空");
                } else {
                    $("#placeError").addClass("hidden");
                }
            });

            $("#vacancy").on("blur", function () {
                if ($("#vacancy").val() === "") {
                    $("#vacancyError").removeClass("hidden");
                    $("#vacancyError>div").text("温馨提示：招聘人数不能为空");
                } else {
                    $("#vacancyError").addClass("hidden");
                }
            });
            ...
            $("#baseconditionCopy").on("blur", function () {
                if ($("#baseconditionCopy").text() === "") {
                    ...
                    $("#baseconditionCopyError>div").text("温馨提示：招聘要求不能为空");
                } else {
