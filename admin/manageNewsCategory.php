...
<head>
    <meta charset="utf-8" />
    <title>杭州北望生物技术有限公司信息管理系统|信息管理</title>
                                    ...
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        foreach($allrows2 as $row2):
                                            ...
                                            <tr><td class="center">
                                                ...
                                                <td class="center"><input type="text" id="categoryName" value="<?php echo $row2['username']; ?>" /></td>
                                                <td class="hidden-480 center"><input type="text" id="categoryRank" value="<?php echo $row2['username']; ?>" /></td>
