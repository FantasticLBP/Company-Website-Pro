                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" href="newTechService.php">发布技术服务</a></div>                            <div class="col-xs-5"></div>
...
<script type="text/javascript">
    ...
    var moudleId = getQueryString("id");
    if(moudleId != null && moudleId !=undefined && moudleId != ""){
        localStorage.setItem("moduleId",moudleId);
    }
    if(moudleId == "" || moudleId == undefined || moudleId == null){
        moudleId = localStorage.getItem("moduleId");
    }
    ...
    function deleteProduct($serviceId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/TechService.php?type=delete&serviceId=" + $serviceId,
