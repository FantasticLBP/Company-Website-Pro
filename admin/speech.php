...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/speech.php"
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right"
                                       for="paragraph1">第一段内容</label>

                                <div class="col-sm-11">
                                    <textarea id="paragraph1" name="paragraph1"
                                              class="autosize-transition form-control col-xs-10 col-sm-5"
                                              placeholder="请输入第一段内容"></textarea>
                                </div>
                            </div>
                            <div class="form-group hidden" id="paragraph1Error">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right"
                                       for="paragraph2">第二段内容</label>

                                <div class="col-sm-11">
                                    <textarea id="paragraph2" name="paragraph2"
                                              class="autosize-transition form-control col-xs-10 col-sm-5"
                                              placeholder="请输入第二段内容"></textarea>
                                </div>
                            </div>
                            <div class="form-group hidden" id="paragraph2Error">
                                <label class="col-sm-1 control-label no-padding-right"></label>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    $("#editId").val(datas.id);
                    $("#paragraph1").val(datas.paragraph1);
                    $("#paragraph2").val(datas.paragraph2);
                }
            },
        ...
        $("#paragraph1").on("blur", function () {
            if ($("#paragraph1").val() === "") {
                $("#paragraph1Error").removeClass("hidden");
                $("#paragraph1Error>div").text("温馨提示：领导致辞第一段不能为空");
            } else {
                $("#paragraph1Error").addClass("hidden");
            }
        });

        $("#paragraph2").on("blur", function () {
            if ($("#paragraph2").val() === "") {
                $("#paragraph2Error").removeClass("hidden");
                $("#paragraph2Error>div").text("温馨提示：领导致辞第二段不能为空");
            } else {
                $("#paragraph2Error").addClass("hidden");
            }
        });
