...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/News.php"
                              method="post" enctype="multipart/form-data" onsubmit="return newsValidate()">

                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="title">服务标题</label>

                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" id="title" name="title" placeholder="请输入合同服务标题"
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="kindtype">新闻类别</label>
                                <div class="col-sm-11">
                                    <select class="col-xs-10 col-sm-10" id="kindtype" name="kindtype">
                                        <option>请选择</option>
                            ...
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="contentCopy">服务内容</label>
                                </div>
                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <div class="wysiwyg-editor col-sm-12 col-md-12 col-lg-12" id="contentCopy"
                                         name="contentCopy"></div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $("#title").on("blur", function () {
            if ($("#title").val() === "") {
                ...
                $("#titleError>div").text("温馨提示：新闻标题不能为空");
            } else {
        ...
        $("#time").on("blur", function () {
            if ($("#time").val() === "") {
                ...
                $("#timeError>div").text("温馨提示：新闻发布时间不能为空");
            } else {
        ...
        $("#contentCopy").on("blur", function () {
            ...
            if ($("#contentCopy").text() === "") {
                ...
                $("#contentCopyError>div").text("温馨提示：新闻内容不能为空");
            } else {
        ...
        $("#kindtype").on("blur", function () {
            if ($("#kindtype").val() === "") {
                ...
                $("#contentCopyError>div").text("温馨提示：请选择新闻类型");
            } else {
        ...
        function newsValidate() {
            ...
            if ($("#kindtype").val() === "" || $("#kindtype").val() == "请选择") {
                $("#kindtypeError").removeClass("hidden");
                $("#kindtypeError>div").text("温馨提示：请选择新闻类型");
                whether = false;
            } else {
                $("#kindtypeError").addClass("hidden");
                whether = true;
