...
<head>
    <meta charset="utf-8"/>
    <title>杭州北望信息管理系统 - 发布生日福利</title>
    <meta name="keywords" content=" 杭州北望信息管理系统,后台管理系统,生物医药,杭州,合同服务"/>
    <meta name="description" content="杭州北望信息管理系统之招贤纳士之发布生日福利"/>
...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Birthday.php"
                              method="post" enctype="multipart/form-data" onsubmit="return birthdayValidate()">

                            <div class="form-group">
                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" name="birthdayId" id="birthdayId" class="col-xs-10 col-sm-10 hidden"/>
                            ...
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <label class="col-sm- control-label no-padding-right" for="contentCopy">生日福利内容</label>
                                </div>
                                <div class="col-sm-11 col-md-11 col-lg-11">
    ...
    <script type="text/javascript">
        ...
        $("#contentCopy").on("blur",function(){
            if ($("#contentCopy").text() === "") {
                ...
                $("#contentCopyError>div").text("温馨提示：生日福利内容不能为空");
            } else {
