                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" id="newBelief" href="newBelief.php">发布人才理念</a></div>                            <div class="col-xs-5"></div>
...
<script type="text/javascript">
    $("#newBelief").click(function (e) {
        e.preventDefault();
        if(parseInt($("#records").val()) >= 4){
            swal("最多有4条人才理念");
        }else {
            window.location.href = "newBelief.php";
        }
    ...
    //删除里程碑
    function deleteProduct($beliefid) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/Belief.php?type=delete&belefId=" + $beliefid,
    ...
    jQuery(function ($) {
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "../controller/Belief.php?type=select",
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td4 = $('<td class=" center">' + datas[i].content + '</td>').appendTo(tr);
