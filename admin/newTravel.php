...
<head>
    <meta charset="utf-8"/>
    <title>杭州北望信息管理系统 - 发布旅游福利</title>
    <meta name="keywords" content=" 杭州北望信息管理系统,后台管理系统,生物医药,杭州,合同服务"/>
    <meta name="description" content="杭州北望信息管理系统之招贤纳士之发布旅游福利"/>
...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/Travel.php"
                              method="post" enctype="multipart/form-data" onsubmit="return staffValidate()">

                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="kind">福利类别</label>

                                <div class="col-sm-11 col-md-11 col-lg-11">
                                    <input type="text" id="kind" name="kind" placeholder="请输入福利类别"
                                           class="col-xs-10 col-sm-10"/>
                                </div>
                            </div>
                            <div class="form-group hidden" id="kindError">
    ...
    <script type="text/javascript">
        ...
        $("#kind").on("blur", function () {
            if ($("#kind").val() === "") {
                $("#kindError").removeClass("hidden");
                $("#kindError>div").text("温馨提示：福利类别不能为空");
            } else {
                $("#kindError").addClass("hidden");
            }
        });
