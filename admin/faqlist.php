                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" href="newfaq.php">发布常见问题</a></div>                            <div class="col-xs-5"></div>
                            <div class="col-xs-5"></div>
    ...
    function deleteProduct($messageId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/FAQLIST.php?type=delete&messageId=" + $messageId,
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td4 = $('<td class=" center">' +  (htmldecode(datas[i].content).toString().length>10? htmldecode(datas[i].content).toString().substr(0,10):htmldecode(datas[i].content)) + '</td>').appendTo(tr);
