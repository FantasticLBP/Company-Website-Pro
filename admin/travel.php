                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" id="newBelief" href="newTravel.php">发布旅游照片</a></div>                            <div class="col-xs-5"></div>
...
<script type="text/javascript">
    ...
    //删除里程碑
    function deleteProduct($travelId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/Travel.php?type=delete&travelId=" + $travelId,
    ...
    jQuery(function ($) {
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "../controller/Travel.php?type=select",
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td3 = $('<td class="hidden-480 center">' + datas[i].kind + '</td>').appendTo(tr);
                        var td4 = $('<td class=" center">' + datas[i].image + '</td>').appendTo(tr);
