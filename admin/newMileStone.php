...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/MileStone.php"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"
                                       for="content">里程碑介绍</label>

                                <div class="col-sm-9">
                                    <textarea id="content" name="content"
                                              class="autosize-transition form-control col-xs-10 col-sm-5"
                                              placeholder="请输入里程碑介绍"></textarea>
                                </div>
                            </div>
                            <div class="form-group hidden" id="content1Error">
                            ...
                            <div class="form-group">
                                <div class="row-fluid ">
                                    <label class="col-sm-3 control-label no-padding-right"
                                           for="availableScope">图片预览</label>
                                    <di class="col-sm-9">
                                        <ul class="ace-thumbnails">
                                            <li id="image">
                                                <a href="" data-rel="colorbox">
                                                    <img width="150" height="150" alt="里程碑图片"/>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-3 control-label red">如果需要修改图片请在下方重新上传</label>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="marketingTime">图片</label>
		...
		try {
            ...
            if(id != ""){
                $.ajax({
                    dataType: "json",
                    type: "get",
                    url: "../controller/MileStone.php?type=one&editId="+id,
                    success: function (data) {
                        if (data.code == 200) {
                            ...
                            if (datas.image != "") {
                                $("#image>a").prop("href", "../"+datas.image);
                                $("#image>a>img").prop("src","../"+datas.image);
                            } else {
                                $("#image>a>img").prop("alt", "未上传图片");
                            }
                        }
                    },
            ...
            $("#companyIntr1").on("blur", function () {
                if ($("#companyIntr1").val() === "") {
                    $("#companyIntr1Error").removeClass("hidden");
                    $("#companyIntr1Error>div").text("温馨提示：公司介绍部分一不能为空");
                } else {
                    $("#companyIntr1Error").addClass("hidden");
                }
            });

            $("#companyIntr2").on("blur", function () {
                if ($("#companyIntr2").val() === "") {
                    $("#companyIntr2Error").removeClass("hidden");
                    $("#companyIntr2Error>div").text("温馨提示：公司介绍部分二不能为空");
                } else {
                    $("#companyIntr2Error").addClass("hidden");
                }
            });
