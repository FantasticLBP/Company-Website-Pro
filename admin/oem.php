                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-lg-2"><a class="btn btn-danger btn-block" href="newoem.php">发布代加工服务</a></div>                            <div class="col-xs-5"></div>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480 center">具体说明</th>
...
<script type="text/javascript">
    ...
    //删除里程碑
    function deleteProduct($manufactureId) {
        ...
        swal({
            ...
            $.ajax({
                dataType: "json",
                type: "get",
                url: "../controller/Manufacture.php?type=delete&manufactureId=" + $manufactureId,
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var td5 = $('<td class=" hidden-480 center">' + datas[i].content + '</td>').appendTo(tr);
