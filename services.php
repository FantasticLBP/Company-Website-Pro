...
<head>
    <meta charset="utf-8">
    <title>杭州北望生物技术有限公司 |代加工服务</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-home pr-10"></i><a href="">科研中心</a></li>
                        <li class="active">产品代加工</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="main-container">
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- main start -->
                <!-- ================ -->
                <div class="main col-md-8" id="servicesPanel">
...
<script>
    jQuery(function ($) {
        ...
        $target = $("#servicesPanel");
        $.ajax({
            dataType: "json",
            type: "get",
            url: "controller/Manufacture.php?type=select",
                ...
                if (data.code == 200) {
                    ...
                    for (var i = 1; i <= datas.length; i++) {
                        var ele = $('<div class="panel-group" id="accordion'+i+'">'+
                            ...
                            '<div class="col-md-12">'+datas[i-1].title+'</div>'+
                            '</a>'+
                            '</h4>'+
                            '</div>'+
                            '<div id="collapse'+i+'" class="panel-collapse collapse'+(i===1?" in":"")+'">'+
                            '<div class="panel-body">'+
                            '<p>具体说明：'+datas[i-1].content+'</p>'+
                            '<p>条件：'+datas[i-1].requirement+'</p>'+
                            '<a href="tencent://message/?uin=2679943834&Site=http://www.lionbiotech.com/services.php&Menu=yes" class="btn btn-white">立即联系<i class="fa fa-chevron-right pl-10"></i> </a>'+
                            '</div>'+
                            '</div>'+
                            '</div>'+
                            '</div>').appendTo($target);
