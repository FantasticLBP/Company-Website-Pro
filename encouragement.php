            ...
            <div class="row">
                        ...
                        <div class="block clearfix">
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="encouragement.php">激励保障</a></li>
                ...
                <div class="main col-md-9">
                    <div class="row">
                        ...
                        <img src="style/images/encouragement.png" class="center-block" id="img">
                            </div>
                    </div>

                    <div class="row">
                        <div class="main col-md-12" id="content">
