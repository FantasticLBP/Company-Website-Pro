        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-12">
                    ...
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title margin-top-clear">预灌装培养平皿</h1>
                    <!-- page-title end -->
                                ...
                                <div class="tab-pane active" id="product-images">
                                    <div class="owl-carousel content-slider-with-controls-bottom">
                                        <div class="overlay-container">
                                            ...
                                            <a href="style/images/YZGPM.png" class="popup-img overlay" title="55 mm预灌装接触性平皿"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                        <div class="overlay-container">
                                            <img src="style/images/YZGPM_use.png" alt="">
                                            <a href="style/images/YZGPM_use.png" class="popup-img overlay" title="90 mm预灌装平皿"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    ...
                                    <div class="tabs-style-2">
                                        ...
                                        <div class="tab-content padding-top-clear padding-bottom-clear">
                                            <div class="tab-pane fade in active" id="h2tab1">
                                                <h4 class="title" id="productSpecification"></h4>
                                                <p>本公司专业提供β-内酰胺类抗生素车间浮游菌、沉降菌、表面微生物检测的解决方案，公司根据β-内酰胺类抗生素生产车间环境微生物监测难点，推出加酶预灌装平皿用于β-内酰胺类抗生素微生物限度的检测、洁净环境微生物状态的检测（浮游菌、沉降菌、表面微生物的测定等）等。本公司具有六年β-内酰胺类抗生素微生物检测解决方案制定经验，所推出的加酶预灌装平皿取代了实验室从原材料的购买、配制、灭菌到浇制的所有工作，在不提高公司检测成本的基础上，既能显著提高酶的工作效率，又能大大降低自身风险。</p>
                                                <p>质量保障:</p>
                                                <p>一重保障：全国独家酶混合技术保持酶的活性；</p>
                                                <p>二重保障：全封闭管道式生产模式；</p>
                                                <p>三重保障：全封闭百级洁净环境自动灌装；</p>
                                                <p>四重保障：钴60辐射灭菌。</p>
                                            </div>
                                            <div class="tab-pane fade" id="h2tab2">
                                                ...
                                                <dl class="dl-horizontal">
                                                    <dt>产品种类</dt>
                                                    <dd>按照客户指定的专用培养基（TSA/NA）定制。 </dd>
                                                    <dt>包装</dt>
                                                    <dd>标准包装：三层无菌塑料袋密封真空包装。</dd>
                                                    <dt>有效期</dt>
                                                    <dd>自辐射灭菌之日起3个月内使用。</dd>
                                                    <dt>种类</dt>
                                                    <dd>90 mm预灌装平皿、55 mm预灌装接触性平皿</dd>
