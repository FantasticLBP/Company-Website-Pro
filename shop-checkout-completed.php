			...
			<div class="page-intro">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								<li><i class="fa fa-home pr-10"></i><a href="index.php
								">主页</a></li>
								<li class="active">祝贺</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-10 col-md-offset-1">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title margin-top-clear text-center">谢谢您!</h1>
							<div class="space"></div>
							<!-- page-title end -->
							<p class="lead text-center">祝亲购物愉快，如果有看中的，果断下单吧，小北竭诚为亲提供最好的服务!</p>
							<div class="text-center"><a href="latest-product.php" class="btn btn-lg btn-default"> 继续购物</a></div>
						</div>
						<!-- main end -->
