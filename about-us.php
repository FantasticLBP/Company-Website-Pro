        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="block clearfix">
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="about-us.php">公司介绍</a></li>
                ...
                <div class="main col-md-9">
                    <div class="separator-2"></div>
                    <p style="text-indent:2em;" id="companyIntroduction"></p>



                    <div class="col-md-3">
                        <div class="image-box mb-20 object-non-visible" data-animation-effect="fadeInLeft"
                             data-effect-delay="300">
                            <div class="overlay-container" id="firstImage">
                                <img  alt="会议室">
                                <div class="overlay">
                    ...
                    <div class="col-md-3">
                        <div class="image-box mb-20 object-non-visible" data-animation-effect="fadeInLeft"
                             data-effect-delay="300">
                            <div class="overlay-container" id="secondImage">
                                <img alt="办公室">

                                <div class="overlay">
                                    <div class="overlay-links">
                                        <a href="" class="popup-img"><i
                                                class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="image-box mb-20 object-non-visible" data-animation-effect="fadeInLeft"
                             data-effect-delay="300">
                            <div class="overlay-container" id="thirdImage">
                                <img  alt="半成品包装车间" >
                    ...
                    <div class="col-md-3">
                        <div class="image-box mb-20 object-non-visible" data-animation-effect="fadeInLeft"
                             data-effect-delay="300">
                            <div class="overlay-container" id="fourthImage">
                                <img  alt="检测人员检测进行中">
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                $("#companyIntroduction").html(datas.description);


                $("#firstImage>img").attr("src",datas.image1);
                $("#secondImage>img").attr("src",datas.image2);
                $("#thirdImage>img").attr("src",datas.image3);
                $("#fourthImage>img").attr("src",datas.image4);

                $("#firstImage").find("a").attr("href",datas.image1);
                $("#secondImage").find("a").attr("href",datas.image2);
                $("#thirdImage").find("a").attr("href",datas.image3);
                $("#fourthImage").find("a").attr("href",datas.image4);
