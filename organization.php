        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="block clearfix">
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="organization.php">组织结构</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="main col-md-9">
                    <div class="row">
                        <img  id="organizationImage" alt="公司组织结构图片">
                    </div>
                </div>
            </div>
        </div>
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                $("#organizationImage").attr("src",data.data[0].structureImage);
            }
        },
