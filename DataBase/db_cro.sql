...
CREATE TABLE `comment` (
  ...
  `time` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT '评价时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, '王武', 5, '物美价廉', 52, '2017-07-31 21:19'),
(2, '李四', 4, '很好的产品', 52, '2017-07-31 23:27'),
(3, '王麻子', 5, '贼棒', 52, '2017-07-31 21:19'),
(4, '水货', 4, '666', 52, '2017-07-31 23:27');
...
CREATE TABLE `order` (
  ...
  `orderTime` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT '下单时间',
  `payMethod` int(1) NOT NULL COMMENT '付款方式：1、货到付款；2、在线支付',
  `productName` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '商品名称',
  `amount` int(10) NOT NULL DEFAULT '1' COMMENT '购买商品的数量',
  `productLevel` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT '商品类别',
  `message` varchar(500) COLLATE utf8_unicode_ci NOT NULL COMMENT '补充信息'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 52, 1, '胡一刀', 80, 1, '2017-08-20 21:08', 0, '青霉素酶冻干粉普通', 1, '普通商品', '麻烦快点配送，我着急用'),
(2, 48, 1, '胡一刀', 80, 1, '2017-08-20 22:08', 0, '青霉素酶冻干粉普通4', 1, '普通商品', '麻烦快点配送，我着急用');
...
CREATE TABLE `user` (
  ...
  `identifier` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT '用于保持用户1周免登录的id，建立用户和一个用户名对应关系',
  `time` int(6) NOT NULL COMMENT '免登录时间',
  `memberCent` int(10) NOT NULL DEFAULT '0' COMMENT '用户会员积分'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, '胡一刀', 'e10adc3949ba59abbe56e057f20f883e', '15757118171', 'wsbglbp@outlook.com', '浙江省杭州市余杭区仓前街道余杭塘路2318号杭州师范大学仓前校区八号楼', '7a01aafbff2aa352e3564dbaac343f9f', 1502517906, 1, 1502431506, 'a596be91b29c88f670e14d573a67b9b7', 1503826552, 12);
