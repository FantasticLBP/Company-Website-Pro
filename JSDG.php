        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-12">
                    ...
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title margin-top-clear">金属β-内酰胺酶冻干粉</h1>
                    <!-- page-title end -->
                                ...
                                <div class="tab-pane active" id="product-images">
                                    <div class="owl-carousel content-slider-with-controls-bottom">
                                        <div class="overlay-container">
                                            ...
                                            <a href="style/images/602JSADG.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                        <div class="overlay-container">
                                            <img src="style/images/602JSADG.jpg" alt="">
                                            <a href="style/images/602JSADG.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                                    ...
                                    <div class="tabs-style-2">
                                        ...
                                        <div class="tab-content padding-top-clear padding-bottom-clear">
                                            <div class="tab-pane fade in active" id="h2tab1">
                                                <h4 class="title" id="productSpecification">≥200万单位/支 8支/盒</h4>
                                                <p>金属β-内酰胺酶（metallo-β-lactamase）, 可水解培南类抗生素以及部分头孢类抗生素。</p>
                                                <p> 本公司采用生物技术，通过色谱层析技术分离纯化，获得了高效的金属β－内酰胺酶。其具有纯度高、活性高、专一性强等特点。</p>
                                                <h4>   适用范围：</h4>
                                                <p> 1、 可以有效的水解培南类抗生素，包括：美罗培南、亚胺培南等。</p>
                                                <P>2、 可用于注射用培南类抗生素药品检验中的无菌检测。</P>
                                                <P>3、 可用于口服及其它培南类抗生素药品检验中的微生物限度检测。</P>
                                            ...
                                            <div class="tab-pane fade" id="h2tab2">
                                                ...
                                                <dl class="dl-horizontal">
                                                    <dt>使用方法：</dt>
                                                    <dd>详见《中国药典》（2015版四部）。</dd>
                                                    <dt>保存条件:</dt>
                                                    <dd>2～8℃保存。</dd>
                                                    <dt>有 效 期:</dt>
                                                    <dd>24个月</dd>
                                                    <dt>执行标准:</dt>
                                                    <dd>Q/HLB 0003-2015</dd>
                    ...
                    <div class="row grid-space-20">
                        ...
                        <div class="col-md-3 col-sm-6 masonry-grid-item">
                            <div class="listing-item">
                                ...
                                <div class="listing-item-body clearfix">
                                    <h3 class="title"><a href="proudct-item.php">青霉素酶液体 10ml</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 masonry-grid-item">
                            <div class="listing-item">
                                ...
                                <div class="listing-item-body clearfix">
                                    <h3 class="title"><a href="proudct-item.php">头孢菌素酶冻干粉</a></h3>
                                    <p>≥200万单位8支/盒</p>
