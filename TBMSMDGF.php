        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-12">
                    ...
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title margin-top-clear">头孢菌素酶冻干粉</h1>
                    <!-- page-title end -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                                ...
                                <div class="tab-pane active" id="product-images">
                                    <div class="owl-carousel content-slider-with-controls-bottom">
                                        <div class="overlay-container">
                                            ...
                                            <a href="style/images/704TBDG.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                        <div class="overlay-container">
                                            <img src="style/images/704TBDG.jpg" alt="">
                                            <a href="style/images/704TBDG.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                            ...
                            <!-- Tab panes end-->
                            <hr>
                            <span class="price"><del>￥0.00</del> ￥0.00</span>
                                    ...
                                    <div class="tabs-style-2">
                                        ...
                                        <div class="tab-content padding-top-clear padding-bottom-clear">
                                            <div class="tab-pane fade in active" id="h2tab1">
                                                <h4 class="title" id="productSpecification">≥200万单位8支/盒</h4>
                                                <p> Cephalosporinase ， EC 3.5.2 .6 ）属β-内酰胺酶的一种，本品可有效水解头孢类抗生素。 本公司采用生物技术，通过色谱层析技术分离纯化，获得了头孢菌素酶。该酶能有效的水解头孢类抗生素，使其失去抗菌活性。</p>
                                                <p> 活性单位定义： 37 ℃ 下，每小时分解头孢菌素活性单位的酶量</p>
                                                <h4>   适用范围：</h4>
                                                <p>  1、本品可水解的头孢菌素包括头孢一代至头孢五代：头孢羟氨苄、头孢拉定、头孢克洛、头孢呋辛、头孢克肟、头孢哌酮、头孢噻肟、头孢曲松、头孢吡肟等。</p>
                                                <P> 2、适用于头孢类抗生素原料及注射用头孢类抗生素药品检验中的无菌检测。</P>
                                                <P> 3、适用于口服及其它头孢类抗生素药品检验中的微生物限度检测.</P>
                                            ...
                                            <div class="tab-pane fade" id="h2tab2">
                                                ...
                                                <dl class="dl-horizontal">
                                                    ...
                                                    <dd>白色或类白色冻干粉末。</dd>
                                                    <dt>使用方法：</dt>
                                                    <dd>详见《中国药典》（2015版第四部）。</dd>
                                                    <dt>保存条件:</dt>
                                                    <dd>2～8℃保存。</dd>
                                                    <dt>有 效 期:</dt>
                                                    <dd>24个月</dd>
                                                    <dt>执行标准:</dt>
                                                    <dd>Q/HLB 0009-2015</dd>
