                        ...
                        <div class="block clearfix">
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="company-glory.php">公司荣誉</a></li>
                    ...
                    <div class="row" id="honorZone">
                        ...
                        foreach ($allrows as $row){
                            for($i=1;$i<count($row);$i++){
                                $tag = "image".$i;
                                if ($row[$tag] != ""){
                                    array_push($images,$row[$tag]);
                                }
                            }
                        }
                        for ($i=1;$i<=count($images);$i++){
                            echo  '<div class="col-md-4">
                            <div class="image-box mb-20 object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="'.(($i-1)*100).'">
                                <div class="overlay-container">
                                    <img src="'.$images[$i-1].'" alt="">
                                    <div class="overlay">
                                        <div class="overlay-links">
                                            <a href="'.$images[$i-1].'" class="popup-img"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
