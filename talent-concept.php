                        ...
                        <div class="block clearfix">
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="talent-concept.php">人才理念</a></li>
                ...
                <div class="main col-md-9">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <h4 class="text-center" id="title1"></h4>
                            <img src="style/images/point-down.jpg">
                            <p class="text-center" id="content1"></p>
                        ...
                        <div class="col-md-3">
                            ...
                            <h4 class="text-center" id="title2"></h4>
                            <img src="style/images/point-down.jpg">
                            <p class="text-center" id="content2"></p>
                        ...
                        <div class="col-md-3">
                            ...
                            <h4 class="text-center" id="title3"></h4>
                            <img src="style/images/point-down.jpg">
                            <p class="text-center" id="content3"></p>
                        ...
                        <div class="col-md-3">
                            ...
                            <h4 class="text-center" id="title4"></h4>
                            <img src="style/images/point-down.jpg">
                            <p class="text-center" id="content4"></p>
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 1; i <= datas.length; i++) {
                        $("#title"+i).text(datas[i-1].title);
                        $("#content"+i).text(datas[i-1].content);
                    }
                }
            },
