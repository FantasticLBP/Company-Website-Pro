...
<script>
                ...
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        $('<div class="col-md-3 col-sm-6 masonry-grid-item">' +
                            ...
                            '<a href="productDetail.php?id='+datas[i].id+'&type=特价商品" class="wishlist" title="wishlist"><i class="fa fa-heart-o"></i></a>' +
                            '<a href="productDetail.php?id='+datas[i].id+'&type=特价商品"><i class="fa fa-shopping-cart pr-10"></i>加入购物车</a>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>').appendTo($node);
    ...
    $("#search").click(function(){
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "controller/productlist.php?type=特价商品&order="+order+"&startPrice="+startPrice+"&endPrice="+endPrice+"&direction="+direction+"&productBigKind="+productBigKind+"&page="+page,
            success: function (data) {
                if (data.code == 200) {
                    var $pagetarget = $(".pagination");
                    var datas = data.data.datas;
