        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="block clearfix">
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active" ><a href="company-philosophy.php">公司理念</a></li>
                ...
                <div class="main col-md-9">
                    ...
                    <h2 class="page-title">01/经营理念</h2>
                    <h4 class="page-header"></h4>

                        <div id="header-1">
                            <p style="text-indent:2em;" id="philosophy"></p>
                           <br>
                            <h2 class="page-title">02/企业愿景</h2>
                        </div>

                        <div id="header-2">
                            <h2 class="page-header"></h2>
                            <p style="text-indent:2em;" id="goal"></p>
                        </div>
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                $("#philosophy").text(datas.philosophy);
                $("#goal").text(datas.goal);
            }
        },
