                    ...
                    <div class="slider-banner">
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1000"
                                ...
                                <!-- main image -->
                                <img src="style/images/slider-shop-slide-1.jpg" alt="slidebg1"
                                ...
                                <div class="tp-caption tp-resizeme hidden-sm sfb"
                                     ...
                                     data-start="600"
                                     data-end="10000"
                                     data-endspeed="600"><a href="latest-product.php" class="btn btn-dark">立即查看 <i
                                            class="fa fa-angle-right pl-10"></i></a>
                                </div>
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1000"
                                ...
                                <!-- main image -->
                                <img src="style/images/slider-shop-slide-2.jpg" alt="slidebg1"
                                     data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                                ...
                                <div class="tp-caption tp-resizeme hidden-sm sfb"
                                     ...
                                     data-start="600"
                                     data-end="10000"
                                     data-endspeed="600"><a href="features-product.php" class="btn btn-dark">立即购买 <i
                                            class="fa fa-angle-right pl-10"></i></a>
                                </div>
                    ...
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row grid-space-10">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control col-xs-6" id="endPrice">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="main col-md-12">
                        ...
                        <!-- page-title start -->
                        <!-- ================ -->
                        <h1 class="page-title">普通产品</h1>

                        <div class="separator-2"></div>
                        <!-- page-title end -->

                        <!-- shop items start -->
                        <div class="masonry-grid-fitrows row grid-space-20" id="shopZone">
...
<script>
    ...
    function refreshView(page) {
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "controller/productlist.php?type=普通商品&page="+$page,
                ...
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        $('<div class="col-md-3 col-sm-6 masonry-grid-item">' +
                            ...
                            '<a href="productDetail.php?id='+datas[i].id+'&type=普通商品" class="overlay small">' +
                            '<i class="fa fa-plus"></i>' +
                            '<span>查看详情</span>' +
                            '</a>' +
                            '</div>' +
                            '<div class="listing-item-body clearfix">' +
                            '<h3 class="title"><a href="productDetail.php?id='+datas[i].id+'&type=普通商品">' + datas[i].productName + '</a></h3>' +
                            '<p>' + datas[i].unit + '</p>' +
                            '<span class="price">¥' + datas[i].price + '</span>' +
                            '<div class="elements-list pull-right">' +
                            '<a href="productDetail.php?id='+datas[i].id+'&type=普通商品" class="wishlist" title="wishlist"><i class="fa fa-heart-o"></i></a>' +
                            '<a href="productDetail.php?id='+datas[i].id+'&type=普通商品"><i class="fa fa-shopping-cart pr-10"></i>加入购物车</a>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>').appendTo($node);
    ...
    $("#search").click(function(){
        ...
        $.ajax({
            dataType: "json",
            type: "get",
            url: "controller/productlist.php?type=普通商品&order="+order+"&startPrice="+startPrice+"&endPrice="+endPrice+"&direction="+direction+"&productBigKind="+productBigKind+"&page="+page,
            success: function (data) {
                if (data.code == 200) {
                    var $pagetarget = $(".pagination");
                    var datas = data.data.datas;
